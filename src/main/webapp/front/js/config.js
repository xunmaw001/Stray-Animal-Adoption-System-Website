...
var centerMenu = [
    ...
    ,{
        name: '宠物收藏',
        url: '../chongwuCollection/list.jsp'
    }
    ,{
        name: '宠物领养订单',
        url: '../chongwuOrder/list.jsp'
    }
...
var indexNav = [
    ...
    {
        name: '宠物',
        url: './pages/chongwu/list.jsp'
    },
    {
        name: '宠物知识科普',
        url: './pages/chongwuzhishi/list.jsp'
    },
    {
        name: '寄养宠物',
        url: './pages/chongwuJiyang/add.jsp'
    },

]

var adminurl =  "http://localhost:8080/liulangdongwulingyang/index.jsp";
