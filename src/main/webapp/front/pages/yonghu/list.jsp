                ...
                <fieldset class="search-container" style="text-align: center;">
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="yonghuPhone" id="yonghuPhone" placeholder="联系方式" autocomplete="off" class="layui-input">
                          </div>
                      </div>
...
<script>
    ...
    // 当前表的字典表
       ...
       function yonghuSexTypesSelect() {
           http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=yonghu_sex_types", 'get', {}, function (res) {
               if(res.code == 0){
       ...
       function yonghuYesnoTypesSelect() {
           http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=yonghu_yesno_types", 'get', {}, function (res) {
               if(res.code == 0){
