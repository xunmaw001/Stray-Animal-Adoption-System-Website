            ...
            <div class="ng-inmod-ini">
                <div class="ng-fault ng-container">
                    <div class="ng-inmod-the ng-container ng-bg-fff">
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">宠物寄养展示</span>
                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="chongwuJiyangName" id="chongwuJiyangName" placeholder="宠物名称" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="yuyueTimeStart" id="yuyueTimeStart"  lay-skin="date"   placeholder="预约时间开始" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          <div class="layui-input-inline" style="margin-top: -29px">
                              <input type="text" name="yuyueTimeEnd"   id="yuyueTimeEnd"    lay-skin="date"   placeholder="预约时间结束" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <select name="chongwuJiyangTypes" id="chongwuJiyangTypes" lay-filter="chongwuJiyangTypes">
                                  <option value="">--请选择--</option>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 chongwuJiyangContent 字段去除无用字符 如果字段长度大于60  就截取到60
            chongwuJiyangContent: function(val) {
                if (val) {
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery', 'laydate'], function() {
        ...
        function pageList() {
            ...
            if (jquery('#chongwuJiyangName').val() != null && jquery('#chongwuJiyangName').val() != "" && jquery('#chongwuJiyangName').val() != "null" ) {
                param['chongwuJiyangName'] = jquery('#chongwuJiyangName').val();
            }
         
            var chongwuTypes = $("#chongwuTypes").find("option:selected").val();
            if (chongwuTypes != null && chongwuTypes != "" && chongwuTypes != "null") {
                param['chongwuTypes'] = chongwuTypes;
            }
                                 
            var chongwuJiankangTypes = $("#chongwuJiankangTypes").find("option:selected").val();
            if (chongwuJiankangTypes != null && chongwuJiankangTypes != "" && chongwuJiankangTypes != "null") {
                param['chongwuJiankangTypes'] = chongwuJiankangTypes;
            }
                                 
            if (jquery('#yuyueTimeStart').val() != null && jquery('#yuyueTimeStart').val() != "" && jquery('#yuyueTimeStart').val() != "null" ) {
                param['yuyueTimeStart'] = jquery('#yuyueTimeStart').val();
            }
            if (jquery('#yuyueTimeEnd').val() != null && jquery('#yuyueTimeEnd').val() != "" && jquery('#yuyueTimeEnd').val() != "null" ) {
                param['yuyueTimeEnd'] = jquery('#yuyueTimeEnd').val();
            }
                 
            var chongwuJiyangTypes = $("#chongwuJiyangTypes").find("option:selected").val();
            if (chongwuJiyangTypes != null && chongwuJiyangTypes != "" && chongwuJiyangTypes != "null") {
                param['chongwuJiyangTypes'] = chongwuJiyangTypes;
            }
                    // 获取列表数据
        ...
        var yuyueTimeStart = laydate.render({
            elem: '#yuyueTimeStart'
            ,type: 'datetime'
            ,done: function (value, dates) {
                yuyueTimeEnd.config.min={
                    year:dates.year,
        ...
        var yuyueTimeEnd = laydate.render({
            elem: '#yuyueTimeEnd'
            ,type: 'datetime'
            ,done: function (value, dates) {
                yuyueTimeStart.config.max={
                    year:dates.year,
                    month:dates.month-1,//关键
                    date: dates.date,
                    hours:dates.hours,
    ...
    // 当前表的字典表
       ...
       function chongwuSexTypesSelect() {
           http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=chongwu_sex_types", 'get', {}, function (res) {
               if(res.code == 0){
       ...
       function chongwuJiankangTypesSelect() {
           http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=chongwu_jiankang_types", 'get', {}, function (res) {
               if(res.code == 0){
       ...
       function chongwuJiyangTypesSelect() {
           http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=chongwu_jiyang_types", 'get', {}, function (res) {
               if(res.code == 0){
