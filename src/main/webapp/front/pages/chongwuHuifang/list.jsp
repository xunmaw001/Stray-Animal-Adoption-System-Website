            ...
            <div class="ng-inmod-ini">
                <div class="ng-fault ng-container">
                    <div class="ng-inmod-the ng-container ng-bg-fff">
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">宠物回访展示</span>
                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="huifangTimeStart" id="huifangTimeStart"  lay-skin="date"   placeholder="回访时间开始" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          <div class="layui-input-inline" style="margin-top: -29px">
                              <input type="text" name="huifangTimeEnd"   id="huifangTimeEnd"    lay-skin="date"   placeholder="回访时间结束" autocomplete="off" class="layui-input">
                          </div>
                      </div>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 chongwuHuifangContent 字段去除无用字符 如果字段长度大于60  就截取到60
            chongwuHuifangContent: function(val) {
                if (val) {
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery', 'laydate'], function() {
        ...
        function pageList() {
            ...
            if (jquery('#huifangTimeStart').val() != null && jquery('#huifangTimeStart').val() != "" && jquery('#huifangTimeStart').val() != "null" ) {
                param['huifangTimeStart'] = jquery('#huifangTimeStart').val();
            }
            if (jquery('#huifangTimeEnd').val() != null && jquery('#huifangTimeEnd').val() != "" && jquery('#huifangTimeEnd').val() != "null" ) {
                param['huifangTimeEnd'] = jquery('#huifangTimeEnd').val();
            }
                                    // 获取列表数据
            http.request('chongwuHuifang/list', 'get', param, function(res) {
        ...
        function dateTimePick(){
            ...
            */
        // 回访时间的开始时间和结束时间的效验及格式
        var huifangTimeStart = laydate.render({
            elem: '#huifangTimeStart'
            ,type: 'datetime'
            ,done: function (value, dates) {
                huifangTimeEnd.config.min={
                    year:dates.year,
        ...
        var huifangTimeEnd = laydate.render({
            elem: '#huifangTimeEnd'
            ,type: 'datetime'
            ,done: function (value, dates) {
                huifangTimeStart.config.max={
                    year:dates.year,
                    month:dates.month-1,//关键
                    date: dates.date,
                    hours:dates.hours,
