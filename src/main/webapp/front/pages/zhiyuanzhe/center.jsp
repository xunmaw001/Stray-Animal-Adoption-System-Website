	...
	<body style="background: #EEEEEE;">
				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="zhiyuanzheName" id="zhiyuanzheName" lay-verify="required" placeholder="姓名" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div  class="layui-input-inline" style="width: 500px">
								<select name="zhiyuanzheSexTypes" id="zhiyuanzheSexTypes">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="zhiyuanzheAge" id="zhiyuanzheAge"  lay-verify="required|integer"   placeholder="年龄" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							<div class="layui-input-block">
								<img id="zhiyuanzhePhotoImg"
									 ...
									 src="../../img/avator.png">
								<input type="hidden" id="zhiyuanzhePhoto" name="zhiyuanzhePhoto"/>
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="zhiyuanzheGongzuo" id="zhiyuanzheGongzuo" lay-verify="required" placeholder="工作" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="zhiyuanzheJine" id="zhiyuanzheJine"  lay-verify="required|integer"   placeholder="收入" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="zhiyuanzheAddress" id="zhiyuanzheAddress" lay-verify="required" placeholder="家庭地址" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="zhiyuanzhePhone" id="zhiyuanzhePhone"  lay-verify="required|phone"   placeholder="联系方式" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="zhiyuanzheIdNumber" id="zhiyuanzheIdNumber"  lay-verify="required|identity"   placeholder="身份证号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="zhiyuanzheAihao" id="zhiyuanzheAihao" lay-verify="required" placeholder="爱好" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div  class="layui-input-inline" style="width: 500px">
								<select name="zhiyuanzheYesnoTypes" id="zhiyuanzheYesnoTypes">
						...
						<div class="layui-form-item">
							...
							<div  class="layui-input-inline" style="width: 500px">
								<select name="zhiyuanzheTypes" id="zhiyuanzheTypes">
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate'], function () {
                ...
                http.request(`zhiyuanzhe/session`, 'get', {}, function (data) {
                    // 表单赋值
                    form.val("myForm", data.data);
					jquery("#zhiyuanzhePhotoImg").attr("src", data.data.zhiyuanzhePhoto);
                });
