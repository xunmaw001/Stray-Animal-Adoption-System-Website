              ...
              <form class="layui-form login-form" lay-filter="register">
                ...
                <div class="layui-form-item layui-form-text input">
                  ...
                  <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="zhiyuanzheName" id="zhiyuanzheName"  placeholder="姓名"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        ...
                        <div class="layui-input-inline">
                            <select name="zhiyuanzheSexTypes" id="zhiyuanzheSexTypes" lay-filter="zhiyuanzheSexTypes" style="width: 600px;">
                ...
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="zhiyuanzheAge" id="zhiyuanzheAge"  lay-verify="integer|required"   placeholder="年龄" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">工作:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="zhiyuanzheGongzuo" id="zhiyuanzheGongzuo"  placeholder="工作"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">收入:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="zhiyuanzheJine" id="zhiyuanzheJine"  lay-verify="integer|required"   placeholder="收入" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">家庭地址:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="zhiyuanzheAddress" id="zhiyuanzheAddress"  placeholder="家庭地址"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
<!-- 手机号 -->
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="zhiyuanzhePhone" id="zhiyuanzhePhone"  lay-verify="phone|required"   placeholder="联系方式" autocomplete="off" class="layui-input" style="width: 400px;">
                        </div>
                    </div>
                </div>
  <!-- 身份证号 -->
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="zhiyuanzheIdNumber" id="zhiyuanzheIdNumber"  lay-verify="identity|required"   placeholder="身份证号" autocomplete="off" class="layui-input" style="width: 400px;">
                        </div>
                    </div>
                </div>
                  <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">爱好:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="zhiyuanzheAihao" id="zhiyuanzheAihao"  placeholder="爱好"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">是否养过宠物:</span>
                        <div class="layui-input-inline">
                            <select name="zhiyuanzheYesnoTypes" id="zhiyuanzheYesnoTypes" lay-filter="zhiyuanzheYesnoTypes" style="width: 600px;">
                ...
                <%--<div class="layui-form-item layui-form-text input">--%>
                    <%--<div class="layui-inline" >--%>
                        <%--<span style="margin-top: 8px;float: left">是否启用:</span>--%>
                        <%--<div class="layui-input-inline">--%>
                            <%--<select name="zhiyuanzheTypes" id="zhiyuanzheTypes" lay-filter="zhiyuanzheTypes" style="width: 600px;">--%>
