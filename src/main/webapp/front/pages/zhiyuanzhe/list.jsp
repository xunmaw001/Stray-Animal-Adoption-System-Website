            ...
            <div class="ng-inmod-ini">
                <div class="ng-fault ng-container">
                    <div class="ng-inmod-the ng-container ng-bg-fff">
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">志愿者展示</span>
                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="zhiyuanzheName" id="zhiyuanzheName" placeholder="姓名" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="zhiyuanzhePhone" id="zhiyuanzhePhone" placeholder="联系方式" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="zhiyuanzheIdNumber" id="zhiyuanzheIdNumber" placeholder="身份证号" autocomplete="off" class="layui-input">
                          </div>
                      </div>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 zhiyuanzheContent 字段去除无用字符 如果字段长度大于60  就截取到60
            zhiyuanzheContent: function(val) {
                if (val) {
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery', 'laydate'], function() {
        ...
        function pageList() {
            ...
            if (jquery('#zhiyuanzheName').val() != null && jquery('#zhiyuanzheName').val() != "" && jquery('#zhiyuanzheName').val() != "null" ) {
                param['zhiyuanzheName'] = jquery('#zhiyuanzheName').val();
            }
                                                         
            if (jquery('#zhiyuanzhePhone').val() != null && jquery('#zhiyuanzhePhone').val() != "" && jquery('#zhiyuanzhePhone').val() != "null" ) {
                param['zhiyuanzhePhone'] = jquery('#zhiyuanzhePhone').val();
            }
         
            if (jquery('#zhiyuanzheIdNumber').val() != null && jquery('#zhiyuanzheIdNumber').val() != "" && jquery('#zhiyuanzheIdNumber').val() != "null" ) {
                param['zhiyuanzheIdNumber'] = jquery('#zhiyuanzheIdNumber').val();
            }
                                            // 获取列表数据
            http.request('zhiyuanzhe/list', 'get', param, function(res) {
    ...
    // 当前表的字典表
       ...
       function zhiyuanzheSexTypesSelect() {
           http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=zhiyuanzhe_sex_types", 'get', {}, function (res) {
               if(res.code == 0){
       ...
       function zhiyuanzheYesnoTypesSelect() {
           http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=zhiyuanzhe_yesno_types", 'get', {}, function (res) {
               if(res.code == 0){
       ...
       function zhiyuanzheTypesSelect() {
           http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=zhiyuanzhe_types", 'get', {}, function (res) {
               if(res.code == 0){
