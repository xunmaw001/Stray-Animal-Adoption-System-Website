    ...
    <div class="data-add-container">
        ...
        <form class="layui-form layui-form-pane" lay-filter="myForm">
            ...
            <div class="layui-form-item" pane>
                ...
                <div class="layui-input-inline">
                    <input v-model="chongwu.chongwuYesnoValue" type="text" readonly="readonly" placeholder="是否被试养" autocomplete="off" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item" pane>
                <label class="layui-form-label">现在所在地址：</label>
                <div class="layui-input-block">
                    <input v-model="detail.xianzaiAddress" type="text" name="xianzaiAddress" id="xianzaiAddress" placeholder="现在所在地址" lay-verify="required" autocomplete="off"
                           class="layui-input">
                </div>
            </div>

            <div class="layui-form-item" pane>
                <label class="layui-form-label">试养时间：</label>
                <div class="layui-input-block">
                    <input v-model="detail.shiyangTime" type="text" name="shiyangTime" id="shiyangTime" placeholder="试养时间" lay-verify="required" autocomplete="off"
                           class="layui-input">
                </div>
            </div>
...
<script>
    ...
    layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate', 'tinymce'], function () {
        ...
        function dateTimePick(){
            ...
            */
            // 试养时间的开始时间和结束时间的效验及格式
            var shiyangTime = laydate.render({
                elem: '#shiyangTime'
                ,type: 'datetime'
