	...
	<body style="background: #EEEEEE;">
					...
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="xianzaiAddress" id="xianzaiAddress" lay-verify="required" placeholder="现在所在地址" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="shiyangTime" id="shiyangTime"  lay-verify="required|date"   placeholder="试养时间" autocomplete="off" class="layui-input">
							</div>
						</div>
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate'], function () {
                ...
                http.request(`chongwuOrder/session`, 'get', {}, function (data) {
                    // 表单赋值
