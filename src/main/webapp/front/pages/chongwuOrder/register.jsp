              ...
              <form class="layui-form login-form" lay-filter="register">
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">现在所在地址:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="xianzaiAddress" id="xianzaiAddress"  placeholder="现在所在地址"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">试养时间:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="shiyangTime" id="shiyangTime"  placeholder="试养时间"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
