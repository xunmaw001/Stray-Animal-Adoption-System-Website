    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑宠物收藏</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">宠物收藏管理</li>
                        <li class="breadcrumb-item active">编辑宠物收藏</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">宠物收藏信息</h3>
...
<script>
    ...
    var tableName = "chongwuCollection";
    ...
    function submit() {
        if (validform() == true && compare() == true) {
           ...
           if($("#yonghuId") !=null){
            ...
            httpJson("chongwuCollection/" + urlParam, "POST", data, (res) => {
                if(res.code == 0){
                    window.sessionStorage.removeItem('addchongwuCollection');
    ...
    // 获取当前详情
    function getDetails() {
        var addchongwuCollection = window.sessionStorage.getItem("addchongwuCollection");
        if (addchongwuCollection != null && addchongwuCollection != "" && addchongwuCollection != "null") {
            //注册表单验证
            $(validform());
            $('#submitBtn').text('新增');
            ...
            window.sessionStorage.removeItem('updateId');
            http("chongwuCollection/info/" + updateId, "GET", {}, (res) => {
                if(res.code == 0)
                {
                    ruleForm = res.data
                    // 是/否下拉框回显
    ...
    function readonly() {
        if (window.sessionStorage.getItem('role') == '管理员') {
            ...
            $(".aaaaaa").remove();
            if(window.sessionStorage.getItem('addchongwuCollection') != null && window.sessionStorage.getItem('addchongwuCollection') !=""){//新增查询,修改不查
                // 查询当前登录账户的信息
                var userId = window.sessionStorage.getItem('userId');
