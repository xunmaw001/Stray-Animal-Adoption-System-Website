            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">宠物领养订单登记</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="chongwuId" name="chongwuId" v-model="ruleForm.chongwuId" readonly type="hidden">
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "chongwuOrder/info/" + id,
