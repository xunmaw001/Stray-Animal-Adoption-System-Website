...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">宠物领养订单管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">宠物领养订单管理</li>
                            <li class="breadcrumb-item active">宠物领养订单列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">宠物领养订单列表</h3>
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
            ...
            var shiyangTimeStartSearch = $('#shiyangTimeStartSearch');
            if( shiyangTimeStartSearch != null){
                if (shiyangTimeStartSearch.val() != null && shiyangTimeStartSearch.val() != '') {
                    searchForm.shiyangTimeStart = $('#shiyangTimeStartSearch').val();
                }
            }
            var shiyangTimeEndSearch = $('#shiyangTimeEndSearch');
            if( shiyangTimeEndSearch != null){
                if (shiyangTimeEndSearch.val() != null && shiyangTimeEndSearch.val() != '') {
                    searchForm.shiyangTimeEnd = $('#shiyangTimeEndSearch').val();
                }
            }
                    getDataList();
        }
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("chongwuOrder/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addchongwuOrder", "addchongwuOrder");
            window.location.href = "add-or-update.jsp"
        }
