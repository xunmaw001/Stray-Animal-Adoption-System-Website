...
<script>
    ...
    function setSelectOption() {
        ...
        if(yonghuSexTypesSelect != null && yonghuSexTypesOptions != null  && yonghuSexTypesOptions.length > 0 ) {
            for (var i = 0; i < yonghuSexTypesOptions.length; i++) {
                if (yonghuSexTypesOptions[i].codeIndex == ruleForm.yonghuSexTypes) {//下拉框value对比,如果一致就赋值汉字
                        yonghuSexTypesSelect.options[i].selected = true;
                }
            }
        }
        ...
        if(yonghuYesnoTypesSelect != null && yonghuYesnoTypesOptions != null  && yonghuYesnoTypesOptions.length > 0 ) {
            for (var i = 0; i < yonghuYesnoTypesOptions.length; i++) {
                if (yonghuYesnoTypesOptions[i].codeIndex == ruleForm.yonghuYesnoTypes) {//下拉框value对比,如果一致就赋值汉字
                        yonghuYesnoTypesSelect.options[i].selected = true;
                }
            }
        }
        <!--  级联表的下拉框回显  -->
