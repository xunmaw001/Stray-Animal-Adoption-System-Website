...
<script>
    ...
    <!-- 初始化当前表的下拉框 -->
        ...
        function initializationyonghuSelect() {
            ...
            if(yonghuSelect != null && yonghuOptions != null  && yonghuOptions.length > 0 ) {
                yonghuSelect.add(new Option("---不选择---", ""));
    ...
    function readonly() {
        if (window.sessionStorage.getItem('role') == '管理员') {
            ...
            $(".aaaaaa").remove();
            if(window.sessionStorage.getItem('addchongwu') != null && window.sessionStorage.getItem('addchongwu') !=""){//新增查询,修改不查
                // 查询当前登录账户的信息
                var userId = window.sessionStorage.getItem('userId');
