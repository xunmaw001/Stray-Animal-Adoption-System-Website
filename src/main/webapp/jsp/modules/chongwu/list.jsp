                ...
                <div class="row breadcrumb-bar">
                    ...
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">宠物列表</li>
                        </ol>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("chongwu/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addchongwu", "addchongwu");
            window.location.href = "add-or-update.jsp"
        }
