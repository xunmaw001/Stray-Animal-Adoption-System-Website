            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">宠物留言登记</li>
                    </ol>
                </div>
            </div>
        </div>
...
<script>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "chongwuLiuyan/info/" + id,
    ...
    function setContent() {
        ...
        if (ruleForm.chongwuLiuyanContent != null && ruleForm.chongwuLiuyanContent != 'null' && ruleForm.chongwuLiuyanContent != '') {
            var chongwuLiuyanContentUeditor = UE.getEditor('chongwuLiuyanContentEditor');
                chongwuLiuyanContentUeditor.ready(function () {
                    var mes = '' + ruleForm.chongwuLiuyanContent;
